...
//
              ...
              // print
              // 4
             // self.performSegue(withIdentifier: "ShowResults", sender: self) // remove this
          }) // till this print here as well
...
//           }
//
//           // 4. let photoColors = imageColors.flatMap({ (dict) -> PhotoColor? in
...
//    headers: ["Authorization": "Basic YWNjXzAxZGM3NGUxNTEyNGRlNDo2NTQ5OWY3ODU3YWJiNTg0Mzc5NGM3YzlhNTI3OWQwNg=="],
//   encodingCompletion: { encodingResult in
//    switch encodingResult {
//                        case .success(let upload, _, _):
//                            upload.uploadProgress { progress in
